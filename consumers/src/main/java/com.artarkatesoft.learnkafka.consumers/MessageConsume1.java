...
public class MessageConsume1 {

    Logger log = LoggerFactory.getLogger(MessageConsume1.class);

    KafkaConsumer<String, String> kafkaConsumer;
    private final String topicName = "test-topic-replicated";

    public MessageConsume1(Map<String, Object> properties) {
    ...
    public static void main(String[] args) {
        MessageConsume1 messageConsumer = new MessageConsume1(buildConsumerProperties());
