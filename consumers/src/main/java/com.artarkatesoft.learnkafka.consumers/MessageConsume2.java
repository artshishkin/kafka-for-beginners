...
public class MessageConsume2 {

    Logger log = LoggerFactory.getLogger(MessageConsume2.class);

    KafkaConsumer<String, String> kafkaConsumer;
    private final String topicName = "test-topic-replicated";

    public MessageConsume2(Map<String, Object> properties) {
    ...
    public static void main(String[] args) {
        MessageConsume2 messageConsumer = new MessageConsume2(buildConsumerProperties());
